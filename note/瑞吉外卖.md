...
![image-20220504213059438](E:\JavaProject\Reggie\note\pictures\image-20220504213059438.png)



2. 角色分工

   ![image-20220504213446025](E:\JavaProject\Reggie\note\pictures\image-20220504213446025.png)
...
3. 软件环境
   ...
   ![image-20220504213704875](E:\JavaProject\Reggie\note\pictures\image-20220504213704875.png)
...
![image-20220504215641403](E:\JavaProject\Reggie\note\pictures\image-20220504215641403.png)
...
![image-20220504215729984](E:\JavaProject\Reggie\note\pictures\image-20220504215729984.png)
...
![image-20220504220120986](E:\JavaProject\Reggie\note\pictures\image-20220504220120986.png)
...
![image-20220504220544306](E:\JavaProject\Reggie\note\pictures\image-20220504220544306.png)
...
![image-20220504222643999](E:\JavaProject\Reggie\note\pictures\image-20220504222643999.png)
...
![image-20220504223008159](E:\JavaProject\Reggie\note\pictures\image-20220504223008159.png)
...
2. 建表
   ...
   */
   ...
   ![image-20220504223337842](E:\JavaProject\Reggie\note\pictures\image-20220504223337842.png)
...
1. 选择`maven`项目
   ...
   ![image-20220504224243270](E:\JavaProject\Reggie\note\pictures\image-20220504224243270.png)

2. 输入项目名，完成

   ![image-20220504224343045](E:\JavaProject\Reggie\note\pictures\image-20220504224343045.png)

3. 初始的`pom`文件，上一步忘写了`artifact`设置的可以直接在pom中改

   ![image-20220504224710302](E:\JavaProject\Reggie\note\pictures\image-20220504224710302.png)

4. 配置完成后，检查`maven`、`jdk`、

   ![image-20220504225058537](E:\JavaProject\Reggie\note\pictures\image-20220504225058537.png)

   ​	![·](E:\JavaProject\Reggie\note\pictures\image-20220504225301064.png)
...
7. 初始项目启动
   ...
   ![image-20220504230904831](E:\JavaProject\Reggie\note\pictures\image-20220504230904831.png)

8. 导入静态资源文件，`backend`存放的时候后台管理的页面文件，`font`存放的前台的展示页面文件

   ![image-20220504231424532](E:\JavaProject\Reggie\note\pictures\image-20220504231424532.png)

9. 由于boot默认的静态资源在`static`文件夹下，所以我们需要自己指定资源文件路径，创建`config`包下的`WebMvcConfig`，在这个里面指定。

   ![image-20220504232925666](E:\JavaProject\Reggie\note\pictures\image-20220504232925666.png)

   * 重新运行项目，效果如图

     ![image-20220504233117036](E:\JavaProject\Reggie\note\pictures\image-20220504233117036.png)		
